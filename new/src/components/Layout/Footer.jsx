    ...
    <footer className="bg-gray-900 dark:bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 space-x-reverse mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold">آب معدنی خوشگوار</h3>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              بیش از دو دهه ارائه آب معدنی با کیفیت برتر به مردم شریف افغانستان
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/quality" className="text-gray-400 hover:text-white transition-colors">کیفیت</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>© ۱۴۰۵ آب معدنی خوشگوار. تمامی حقوق محفوظ است.</p>
        </div>
      </div>
    </footer>
  );
